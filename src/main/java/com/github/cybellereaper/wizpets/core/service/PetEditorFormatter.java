...
final class PetEditorFormatter {
  ...
  static List<String> summaryLines(PetRecord record, TalentRegistryView registry) {
    ...
    lines.add("§8Use §d/wizpet edit name <name>§8 to rename your pet.");
    lines.add("§8Use §d/wizpet edit reroll§8 to reroll all talents.");
    lines.add("§8Use §d/wizpet edit talent <slot>§8 to reroll a single talent.");
