...
class PetStorage(private val plugin: JavaPlugin) {
    ...
    private val scriptKey = NamespacedKey(plugin, "script_id")
    ...
    fun load(player: Player): PetData? {
        ...
        val scriptId = container.get(scriptKey, PersistentDataType.STRING) ?: "default"
    ...
    fun save(player: Player, data: PetData) {
        ...
        container.set(scriptKey, PersistentDataType.STRING, data.scriptId)
